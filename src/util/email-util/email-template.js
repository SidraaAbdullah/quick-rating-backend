...
const googleApiUtil = require(appRoot + '/src/api/v1/restaurants/util/google-apis');
...
exports.waiterAddEmailTemplate = async (restaurant, userDetails) => {
  return `<div>
        ...
        Please create an account on Quick Rating Application, It is available on Apple and Play Store.
    </div>`;
};

exports.userEmailAfterTippingTemplate = async (
  restaurant,
  userDetails,
  waiterVoting,
  tip,
